...
diabetes <- read.csv("https://raw.githubusercontent.com/info201b-2022-spring/final-projects-achandru1/main/data/diabetes_012_health_indicators_BRFSS2015.csv?token=GHSAT0AAAAAABUCQWQBSOZIXFGNKLVZL262YUKW2LQ")
